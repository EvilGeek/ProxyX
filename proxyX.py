...
def update():
    ...
    data = request.get(f"https://raw.githubusercontent.com/EvilGeek/ProxyX/master/{f}").text
    ...
    print("By using"+BOLD+"python3 proxyX.py"+END)
...
▒█▄▄█ ▀▀▀▀ ▀▀▀░ ▀▀▀ ▀░░▀ ░░▀░░ ▄▀▒▀▄\n\n"""+END)
    ...
    print(GREEN+"Grab HTTP/SOCKS4/SOCKS5 Proxies Easily with CodentX Proxy Scrapper Tool.\nTG : CodentX"+END)
    ...
    while True:
        ...
        try:
            ...
            if homeChoice==1:
            	...
            	lv = request.get("https://raw.githubusercontent.com/EvilGeek/ProxyX/master/.version").text                if v != lv:
